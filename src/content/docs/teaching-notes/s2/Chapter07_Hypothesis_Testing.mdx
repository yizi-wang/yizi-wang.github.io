...
$H_0$: \underline{\hspace{4cm}} \quad $H_1$: \underline{\hspace{4cm}} \quad Test type: \underline{\hspace{3cm}}
...
Test statistic: $X = $ \underline{\hspace{2cm}}

Under $H_0$: $X \sim$ \underline{\hspace{4cm}}

**Step 3:** Calculate the p-value

Expected value under $H_0$: $E(X) = $ \underline{\hspace{2cm}}

Since $X = 40$ \underline{\quad} $E(X)$, we use the \underline{\hspace{3cm}} tail.

p-value = \underline{\hspace{6cm}}
