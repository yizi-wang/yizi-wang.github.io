...
<Aside type="note" title="Voting Exercise: Which approach seems most fair?">
...
<Aside type="success" title="Reframed Question">
...
<Aside type="note" title="Critical Thinking Exercise">
...
<Aside type="note" title="Exercise 1: Identifying Binomial Distributions">
...
<Aside type="note" title="Exercise 2: Mastering the Binomial Cumulative Distribution Table">
...
<Aside type="note" title="Exercise 3: Back to the Knights">
...
<Aside type="note" title="Introduction to PGFs">
...
<Aside type="note" title="Challenge 1: Derive the PGF">
...
<Aside type="note" title="Challenge 2: Discovering the Moment Formulas">
...
<Aside type="note" title="Challenge 3: Applying the Moment Formulas">
...
<Aside type="note" title="Challenge 4: The Ultimate Application">
...
<Aside type="note" title="Final Challenge: The Tournament Problem">
