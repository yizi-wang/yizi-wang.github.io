...
|---|-------|------------|----------------|
| 1 | Algebra Algebra | Standard | Vedic theorem, relationship between polynomial roots and coefficients, properties of geometric sequence |
| 2 | Analysis Analysis | Challenging | Derivatives to determine monotonicity, function image analysis, and segmented discussion of parameter ranges |
| 3 | Calculus Calculus | Standard | Transformation of Riemann sum into definite integral, relationship between limit and integral |
| 4 | Geometry | Standard | Euler's formula V-E+F=2, counting relationship between faces and vertices, integer constraint analysis |
| 5 | Sequences and Recurrence | Challenging | Mathematical induction, substitution of recursive relations, deformation of algebraic identities |
| 6 | Parametric Curves and Area | Challenging | Trigonometric parameterization, Green's area formula, beta function integration |
| 7 | Abstract Algebra/Group Theory | Challenging | Direct verification of associative laws, solution of unit elements and inverse elements, subgroup construction |
| 8 | Ordinary Differential Equations | Challenging | Second-order constant coefficient ODE, piecewise splicing, continuity matching, infinite series summation |
...
**Topic**: Geometry &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Sequences and Recurrence &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Parametric Curves and Area &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Abstract Algebra/Group Theory &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Ordinary Differential Equations &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
