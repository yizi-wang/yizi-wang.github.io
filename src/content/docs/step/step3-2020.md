...
$$\frac{\mathrm{d}^2y}{\mathrm{d}x^2} + (\mathrm{g}(x) + \mathrm{f}(x))\frac{\mathrm{d}y}{\mathrm{d}x} + (\mathrm{g}'(x) + \mathrm{f}(x)\mathrm{g}(x))y = \mathrm{h}(x). \tag{1}$$

(ii) Given that the differential equation

$$\frac{\mathrm{d}^2y}{\mathrm{d}x^2} + \left(1 + \frac{4}{x}\right)\frac{\mathrm{d}y}{\mathrm{d}x} + \left(\frac{2}{x} + \frac{2}{x^2}\right)y = 4x + 12 \tag{2}$$
