...
|---|-------|------------|----------------|
| 1 | Binomial Expansion | Routine | Binomial theorem, series truncation, error analysis |
| 2 | Floor Function and Series | Standard | Rounding functions, piecewise analysis, geometric series summation, limits |
| 3 | Solid Geometry | Standard | Vector dot product, solid geometry, inequality proof |
| 4 | Trigonometric Equations | Challenging | Trigonometric identities, factorization, discriminant analysis |
| 5 | Calculus | Standard | Integral, stationary point judgment, curve sketch, exponential function |
| 6 | Integration | Challenging | Polynomial long division, integral by parts, integral by substitution |
| 7 | Complex Numbers | Challenging | Complex number geometric representation, rotation, equation solving of circles |
| 8 | Differential Equations | Challenging | Properties of periodic functions, separation of variables method, exponential decay |

---

## Question 1

**Topic**: Binomial Expansion Binomial Expansion &nbsp;|&nbsp; **Difficulty**: Routine &nbsp;|&nbsp; **Marks**: 20
...
So the degree 2 approximation is:
 ...
 $$
\sqrt{1 - x} \approx 1 - \frac{x}{2} - \frac{x^2}{8} \qquad (*)
$$ 
...
**Topic**: Floor Function and Series &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Solid Geometry &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Trigonometric Equations &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Calculus Calculus &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
We note that  $\tan(5\pi/12) = \tan 75^\circ = 2 + \sqrt{3}$ , so  $\theta_C = 5\pi/12$ .
