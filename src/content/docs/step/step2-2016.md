...
|---|-------|------------|----------------|
| 1 | Curves and Equations | Standard | Derivatives of parametric equations, tangent equations, vector vertical conditions, simultaneous equation elimination, polynomial factorization |
| 2 | Algebra (Algebra) | Standard | Factor theorem, decomposition of symmetric polynomials, substitution of variables, root finding of equations |
| 3 | Polynomials and Series (Polynomials and Series) | Challenging | Term-by-term derivation, polynomial symbolic analysis, proof by contradiction (infinite root contradiction), intermediate value theorem, asymptotic behavior at infinity |
| 4 | Inequalities and Functions | Challenging | Quadratic equation discriminant, auxiliary angle formula R cos(theta+alpha), inequality transitivity, radical simplification |
| 5 | Combinatorics | Challenging | Negative binomial expansion, power series multiplication comparison coefficients, Vandermonde identity, expansion of the definition of combinatorial numbers |
| 6 | Differential Equations | Challenging | Verify solutions to differential equations, chain rule, function composition, Chebyshev polynomial properties |
| 7 | Integration (Integration) | Standard | Integral substitution $u=a-x$, trigonometric identities, logarithmic operations, integration by parts |
| 8 | Series and Integration Approximation (Series and Integration Approximation) | Challenging | Integral approximation series, sketch argument, error analysis, midpoint approximation |

---

## Question 1

**Topic**: Curves and Equations &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Polynomials and Series &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Inequalities and Functions &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Combinatorics &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Series and Integration Approximation &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
For part (ii), evaluate the integral for one particular term of the sum and note that it is approximately  $\frac{1}{4r^4}$ . Finally, using the most accurate estimate for  $E$  (namely  $\frac{33}{20}$ ), the sum from  $r = 3$  onwards can be calculated and then the first two values of  $\frac{1}{r^4}$  can be added to achieve the desired result.
