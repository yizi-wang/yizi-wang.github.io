...
|---|-------|------------|----------------|
| 1 | Integration (Integration) | Standard | Integral by parts, recurrence relations, mathematical induction, summation of series |
| 2 | Sequences and Periodicity | Challenging | Function composition, recursive sequence, periodic analysis, algebraic factorization |
| 3 | Trigonometric Functions and Graphs | Challenging | General solution of trigonometric equations, derivation of implicit functions, image symmetry, cosine identity |
| 4 | Integral Inequalities | Challenging | Schwartz's inequality, integral inequalities, function selection, trigonometric integral |
| 5 | Parametric Equations and Parabolas | Standard | Parametric equations, normal equation, distance formula, derivative extreme value, circle angle theorem |
| 6 | Mathematical induction and inequalities, Mathematical Induction and Inequalities | Challenging | Mathematical induction, inequality scaling, square elimination method |
| 7 | Exponential Functions and Limits, Exponential Functions and Limits | Challenging | Logarithmic derivation method, exponential function analysis, inequality proof, limit calculation |
| 8 | Vectors and Triangle Geometry, Vectors and Triangle Geometry | Standard | Vector straight line equations, scalar product determination perpendicularity, vector algebra operations |
...
**Topic**: Sequences and Periodicity &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Trigonometric Functions and Graphs &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Integral Inequalities &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Parametric Equations and Parabolas &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Mathematical Induction and Inequalities &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Exponential Functions and Limits &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Vectors and Triangle Geometry &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
