...
|---|-------|------------|----------------|
| 1 | Algebra (Algebra) | Challenging | Reciprocal root substitution, factorization, discriminant analysis |
| 2 | Analysis (Analysis) | Challenging | Definition of concave function, Jensen's inequality, second-order derivative discrimination, logarithmic transformation |
| 3 | Calculus (Calculus) | Challenging | Chain derivation, rotational symmetry conditions, integral substitution |
| 4 | Trigonometry | Standard | Sum and difference product formulas, factorization, cosine equality conditions |
| 5 | Series and Integration (Series and Integration) | Challenging | Binomial expansion, term-by-term integration, series expansion, substitution method |
| 6 | Number Theory (Number Theory) | Challenging | Prime number determination, factorial prime factor analysis, case-by-case discussion, inequality estimation |
| 7 | Vectors | Challenging | Vector collinearity conditions, proportional relationships, area ratios, similar triangles |
| 8 | Differential Equations | Challenging | Variable substitution, separation of variables method, integration techniques, asymptote analysis, graph comparison |

---

## Question 1

**Topic**: Algebra &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Analysis &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Series and Integration &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Vectors &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
