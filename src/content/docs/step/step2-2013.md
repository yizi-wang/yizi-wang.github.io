...
|---|-------|------------|----------------|
| 1 | Logarithms and Exponentials | Challenging | Implicit function derivation, logarithmic identity, function monotonicity analysis, image demonstration |
| 2 | Integration and Reduction Formulae | Challenging | Recursion relationship, substitution method, relationship between Beta function and factorial, trigonometric substitution |
| 3 | Cubic Equations and Root Analysis | Challenging | Vedic Theorem, Function Image Analysis, Extreme Point Discussion, Counterexample Construction |
| 4 | Coordinate Geometry and Loci | Challenging | Simultaneous equations, parameter elimination, locus equations, properties of the chord midpoint of a circle |
| 5 | Function Symmetry and Stationary Points | Hard | Implicit function derivation, symmetry analysis, curve drawing, algebraic equation solution |
| 6 | Sequences and Limits | Challenging | Simplification of recursion relations, proof of boundedness by mathematical induction, monotonic convergence theorem, subsequence limit argument |
| 7 | Number Theory | Challenging | Recursive generation of solutions to Pell equation, algebraic deformation and parity analysis, discussion of factorization classification, solution of Diophantine equation |
| 8 | Calculus Calculus | Challenging | Derivative extreme value, integral mean function, geometric area comparison, inequality proof |

---

## Question 1

**Topic**: Logarithms and Exponentials &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Integration and Reduction Formulae &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Cubic Equations and Root Analysis &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Coordinate Geometry and Loci &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Function Symmetry and Stationary Points &nbsp;|&nbsp; **Difficulty**: Hard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Sequences and Limits &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Number Theory Number Theory &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
