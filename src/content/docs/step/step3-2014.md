...
|---|-------|------------|----------------|
| 1 | Algebra and Series (Algebra and Series) | Challenging | Symmetric polynomials, logarithmic series expansion, coefficient comparison, counterexample construction |
| 2 | Integration (Integration) | Standard | Hyperbolic function identities, substitution integration method, fraction decomposition, definite integral calculation |
| 3 | Coordinate Geometry and Optimization (Coordinate Geometry and Optimisation) | Challenging | Parabolic parametric equations, normal equations, distance optimization, classification discussion |
| 4 | Integral Inequalities | Hard | Complete differentiation, integral identities, $\sec^2 x = 1 + \tan^2 x$, boundary conditions, integration factors |
| 5 | Complex Numbers and Geometry (Complex Numbers and Geometry) | Challenging | Complex numbers represent vectors, parallelogram determination, square determination, rotation multiplication $i$, necessary and sufficient conditions |
| 6 | Analysis (Analysis) | Hard | Sign preservation of positive function integrals, quadratic integration method, convex function determination, trigonometric hyperbolic function construction |
| 7 | Geometry | Hard | Chordal properties of circles, vector representation, proof by contradiction, similar triangles |
| 8 | Series and Number Theory (Series and Number Theory) | Hard | Block summation estimation, geometric series bounds, number combination counting, harmonic series divergence |

---

## Question 1

**Topic**: Algebra and Series (Algebra and Series) &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
Substituting back, the  $\frac{\sqrt{2}}{2}$ -type terms cancel with parts of the  $\frac{1}{2}\int \frac{du}{u^2 \pm \sqrt{2}u + 1}$  contributions, and we are left with:
 ...
 $$
I = \frac{1}{4\sqrt{2}}\left[\ln(u^2+\sqrt{2}\,u+1) - \ln(u^2-\sqrt{2}\,u+1)\right]_0^1 + \frac{1}{4}\int_0^1 \frac{du}{u^2+\sqrt{2}\,u+1} + \frac{1}{4}\int_0^1 \frac{du}{u^2-\sqrt{2}\,u+1}.
$$ 
...
**Combining:**
 ...
 $$
I = \frac{\ln(1+\sqrt{2})}{2\sqrt{2}} + \frac{1}{4} \cdot \frac{\pi\sqrt{2}}{2} = \frac{\ln(1+\sqrt{2})}{2\sqrt{2}} + \frac{\pi}{4\sqrt{2}} = \frac{\pi + 2\ln(\sqrt{2}+1)}{4\sqrt{2}}.
$$ 
...
**Topic**: Coordinate Geometry and Optimisation &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Integral Inequalities &nbsp;|&nbsp; **Difficulty**: Hard &nbsp;|&nbsp; **Marks**: 20
...
**The endpoint case  $a = k = \frac{\pi}{2}$ .** The square-integral argument above suggests where equality should come from. If the integrand were zero, it would satisfy

 $$y' + ay\tan(ax) = 0,$$ 

whose non-zero solutions have the form  $y = C\cos(ax)$ . For  $a < \frac{\pi}{2}$ , the condition  $y(1)=0$  would still force  $C=0$ ; at the endpoint  $a=\frac{\pi}{2}$  it no longer does, because  $\cos\frac{\pi}{2}=0$ .

So take

 $$y(x) = \cos\frac{\pi x}{2}.$$ 

This function is not identically zero and satisfies  $y(1)=0$ . Let  $c=\frac{\pi}{2}$ . Then  $y'=-c\sin(cx)$ , so

 $$J = \int_0^1 \left((y')^2 - c^2y^2\right)\,dx = c^2\int_0^1 \left(\sin^2(cx)-\cos^2(cx)\right)\,dx.$$ 

Since  $\sin^2 u-\cos^2 u=-\cos(2u)$ ,

 $$J = -c^2\int_0^1 \cos(2cx)\,dx = -\frac{c}{2}\left[\sin(2cx)\right]_0^1 = 0.$$ 

Thus  $y(x)=\cos\frac{\pi x}{2}$  is a non-zero function satisfying the boundary condition and giving  $J=0$ .
...
**Topic**: Analysis &nbsp;|&nbsp; **Difficulty**: Hard &nbsp;|&nbsp; **Marks**: 20
...
Choose  $h(x) = \sin x \cosh x - x$ . Then  $h(0) = 0$  and  $h'(x) = \cos x \cosh x + \sin x \sinh x - 1$ , so  $h'(0) = 0$ . Now
 $$h''(x) = 2\cos x \sinh x > 0 \quad \text{for } 0 < x < \frac{1}{2}\pi.$$ 
By the stem result,  $h(x) > 0$  for  $0 < x < \frac{1}{2}\pi$ , so  $\sin x \cosh x > x$ , giving  $\frac{\sin x}{x} > \frac{1}{\cosh x}$  for  $0 < x < \frac{1}{2}\pi$ . Combining:  $\frac{1}{\cosh x} < \frac{\sin x}{x} < \frac{x}{\sinh x}$ .
...
**Topic**: Geometry &nbsp;|&nbsp; **Difficulty**: Hard &nbsp;|&nbsp; **Marks**: 20
...
(i) Since  $P_1P_2P_3P_4$  is cyclic,  $\angle P_1P_4Q = \angle P_1P_2P_3$  and  $\angle P_2P_3Q = \angle P_2P_3P_1$ . These are equal because they subtend the same chord  $P_1P_2$ . Similarly,  $\angle P_4P_1Q = \angle P_4P_1P_3$  and  $\angle P_3P_2Q = \angle P_3P_2P_4$ , and these are equal because they subtend the same chord  $P_3P_4$ . Thus  $\triangle P_1QP_4 \sim \triangle P_2QP_3$  (AA similarity). Therefore  $\frac{P_1Q}{P_2Q} = \frac{QP_4}{QP_3}$ , giving  $(P_1Q)(QP_3) = (P_2Q)(QP_4)$ .
...
-  $\angle P_1P_4Q = \angle P_2P_3Q$ : these are  $\angle P_1P_4P_2$  and  $\angle P_2P_3P_1$ , which subtend chord  $P_1P_2$ .
-  $\angle P_4P_1Q = \angle P_3P_2Q$ : these are  $\angle P_4P_1P_3$  and  $\angle P_3P_2P_4$ , which subtend chord  $P_3P_4$ .
...
**Topic**: Series and Number Theory &nbsp;|&nbsp; **Difficulty**: Hard &nbsp;|&nbsp; **Marks**: 20
