...
|---|-------|------------|----------------|
| 1 | Trigonometry and Polynomial Roots | Challenging | Expansion of compound angle formulas, Vedic theorem (relationship between roots and coefficients), substitution of tangent to polynomial |
| 2 | Series and Binomial Theorem (Series and Binomial Theorem) | Challenging | Simplification of factorial expressions, expansion of binomial series, term-by-term differentiation and integration of power series, substitution of specific values for summation |
| 3 | Fibonacci Sequences and Mathematical Induction | Challenging | Mathematical induction, Fibonacci recurrence relations, identity deformation and simplification |
| 4 | Parametric Equations and Differential Geometry | Challenging | Derivatives of parametric equations, chain rule, curvature formula, calculation of center of curvature |
| 5 | Hyperbolic Functions and Higher Derivatives (Hyperbolic Functions and Higher Derivatives) | Hard | Hyperbolic function substitution, implicit function derivation, higher-order derivative calculation, mathematical induction |
| 6 | Complex Numbers | Hard | Polar coordinate form of complex numbers, conjugate operation of complex numbers, vertical condition transformation |
| 7 | Integration (Integration) | Challenging | Variable substitution, definite integral splitting, functional equations, relationship between series and integrals |
| 8 | Differential Equations | Challenging | General solution of linear ODE, substitution of Riccati equation, substitution of initial value conditions |

---

## Question 1

**Topic**: Trigonometry and Polynomial Roots &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Series and Binomial Theorem (Series and Binomial Theorem) &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
(i)
 $$1\cdot3\cdot5\cdots(2n - 1) = \frac{1\cdot2\cdot3\cdots2n}{2\cdot4\cdot6\cdots2n} = \frac{(2n)!}{2^n(1\cdot2\cdot3\cdots n)} = \frac{(2n)!}{2^n n!}$$ 

Using the binomial theorem, which is valid given the condition  $|x| < \frac{1}{4}$ ,

 $$(1-4x)^{-\frac{1}{2}} = 1 + \frac{-\frac{1}{2}}{2}(-4x) + \frac{\frac{-1}{2} \cdot \frac{-3}{2}}{2!}(-4x)^2 + \cdots$$ 
 $$= 1 + 1\cdot(2x) + \frac{1\cdot3}{2!}(2x)^2 + \cdots + \frac{1\cdot3\cdot5\cdots(2n - 1)}{n!}(2x)^n + \cdots$$ 
...
Equivalently,  $\frac{2^{n+1}}{3^{2n}} = \frac{2 \cdot 2^n}{9^n} = 2 \cdot \left(\frac{2}{9}\right)^n$ , so
...
**Topic**: Fibonacci Sequences and Mathematical Induction (Fibonacci Sequences and Mathematical Induction) &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Parametric Equations and Differential Geometry &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Hyperbolic Functions and Higher Derivatives &nbsp;|&nbsp; **Difficulty**: Hard &nbsp;|&nbsp; **Marks**: 20
...
We use the pattern already visible in (i) and (ii). Since  $r=\operatorname{cosech}\theta$ , we have  $r^{-m}=\sinh^m\theta$  and

 $$\frac{\mathrm{d}\theta}{\mathrm{d}x}=-\sinh^2\theta.$$ 

For any positive integer  $m$ ,

 $$
\frac{\mathrm{d}}{\mathrm{d}x}\left(\frac{\cosh m\theta}{r^m}\right)
= -m\frac{\cosh((m+1)\theta)}{r^{m+1}}.
$$ 

because differentiating  $\sinh^m\theta\cosh m\theta$  with respect to  $\theta$  gives

 $$
m\sinh^{m-1}\theta\left(\cosh\theta\cosh m\theta+\sinh\theta\sinh m\theta\right)
=m\sinh^{m-1}\theta\cosh((m+1)\theta),
$$ 

and multiplying by  $\frac{\mathrm{d}\theta}{\mathrm{d}x}=-\sinh^2\theta$  gives the displayed result.

Applying this with  $m=2$  to (ii),

 $$
\frac{\mathrm{d}^3y}{\mathrm{d}x^3}
= -2\left(-2\frac{\cosh 3\theta}{r^3}\right)
...
Therefore
 ...
 $$a^2(p-q) = qq^*p - pp^*q = pq(q^* - p^*) = -pq(p^* - q^*).$$ 
...
so  $t\left(\frac{1}{x}\right) + t(x) = \int_{0}^{\frac{1}{x}} \frac{1}{1 + u^2} du + \int_{\frac{1}{x}}^{\infty} \frac{1}{v^2 + 1} dv = \int_{0}^{\infty} \frac{1}{1 + u^2} du = \frac{1}{2}p$ 
...
results gives  $3t\left(\frac{1}{\sqrt{3}}\right) = \int_{0}^{\infty} \frac{1}{1+u^2} \, du = \frac{1}{2}p$ 
...
We have three equal integrals for  $t\!\left(\frac{1}{\sqrt{3}}\right)$ :
