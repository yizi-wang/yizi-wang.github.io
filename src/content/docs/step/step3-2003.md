...
|---|-------|------------|----------------|
| 1 | Calculus Calculus | Standard | Chain rule, derivation of inverse functions, integral by substitution |
| 2 | Series & Combinatorics | Challenging | Combinatorial identities, generalized binomial theorem, summation of power series |
| 3 | Calculus Calculus | Standard | Derivation of business law, properties of odd and even functions, function image analysis |
| 4 | Analytic Geometry & Parametric Equations | Challenging | Parametric equations to find tangents, recurrence relations, trigonometric identities |
| 5 | Algebra & Equation Theory | Challenging | Discriminant, Vedic theorem, extreme value analysis, necessary and sufficient conditions |
| 6 | Trigonometry | Challenging | Proof of trigonometric identities, summation of split terms, solution of trigonometric equations |
| 7 | Coordinate Geometry | Challenging | Coordinate geometry, vector projection, collinear conditions |
| 8 | Differential Equations | Challenging | Implicit function derivation, variable substitution, differential equation solution |
...
**Topic**: Series & Combinatorics &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Analytic Geometry & Parametric Equations &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
Collecting terms gives
 ...
 $$2tT^3 - (1+3t^2)T^2 + 2tT + t^2(t^2-1) = 0.$$ 

Since  $T=t$  is a root, write

 $$2tT^3 - (1+3t^2)T^2 + 2tT + t^2(t^2-1)=(T-t)(2tT^2+c_1T+c_0).$$ 
...
-  $T^0$ :  $-c_0t = t^2(t^2-1)$ , so  $c_0 = -t(t^2-1) = t(1-t^2)$ .
...
For  $\alpha_0=5\pi/18$ , we have  $\alpha_1=\pi/2-10\pi/18=-\pi/18$ ,  $\alpha_2=\pi/2+2\pi/18=11\pi/18$ , and  $\alpha_3=\pi/2-22\pi/18=-13\pi/18\equiv5\pi/18\pmod{\pi}$ . Thus  $t_3=t_0$  and  $t_1=\tan(-\pi/18)\ne\tan(5\pi/18)=t_0$ .
...
**Topic**: Algebra & Equation Theory Algebra & Equation Theory &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Coordinate Geometry Coordinate Geometry &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
Now consider the given condition:  $\left(\frac{t-b}{s}\right)\left(\frac{t}{s-a}\right) = -1$ .
 ...
 $$t^2 - bt + s^2 - as = 0 \implies t(b-t) + s(a-s) = bt - t^2 + as - s^2 = 0.$$ 

Therefore  $N$  lies on  $XY$ .  $\qquad \text{(shown)}$ 

**Step 3: Geometrical interpretation.**

The condition  $\frac{t-b}{s} \cdot \frac{t}{s-a} = -1$  means  $\frac{t-b}{s-0} \cdot \frac{t-0}{s-a} = -1$ . The first factor is the gradient of  $PB$  (since  $B = (0,b)$  and  $P = (s,t)$ ), and the second factor is the gradient of  $PA$  (since  $A = (a,0)$ ). The product of gradients being  $-1$  means  $PA \perp PB$ , i.e.,  $\angle APB=90^\circ$ .
...
Since
 ...
 $$na(y+bx)+b(y+ax)=(na+b)y+ab(n+1)x,$$ 

and

 $$n(y+bx)+(y+ax)=(n+1)y+(nb+a)x,$$ 
...
Thus the coefficients are proportional. Let the common proportionality constant be  $k$ :

 $$-ab(n+1) = 10k, \quad -(na+b) = -4k, \quad nb+a = 3k, \quad n+1 = -k.$$ 

From  $n+1=-k$ , we have  $k=-(n+1)$ . Hence

 $$na+b=-4(n+1), \qquad nb+a=-3(n+1), \qquad ab=10.$$ 
...
**Case  $n = 2$ **:  $b = \frac{4-6}{1} = -2$  and  $a = \frac{3-8}{1} = -5$ , giving  $ab=10$ .

So  $(y - 5x)^2(y - 2x) = C$ .

**Case  $n = \frac{1}{2}$ **:  $b = \frac{4 - 3/2}{-1/2} = \frac{5/2}{-1/2} = -5$  and  $a = \frac{3-2}{-1/2} = \frac{1}{-1/2} = -2$ , again giving  $ab=10$ .
