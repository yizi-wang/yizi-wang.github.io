...
|---|-------|------------|----------------|
| 1 | Calculus (Calculus) | Standard | Curvature formula, chain derivation, trigonometric function derivation |
| 2 | Trigonometry | Challenging | Triple angle formula, substitution method, indefinite and definite integrals |
| 3 | Sequences and Series (Sequences and Series) | Standard | Characteristic equations, undetermined coefficient method, summation of geometric series |
| 4 | Integration | Challenging | Substitution method, integral symmetry, King property |
| 5 | Vectors | Challenging | Vector dot product, direction cosine, cone equation |
| 6 | Solid Geometry | Standard | Three-dimensional coordinate geometry, Pythagorean theorem, dihedral angle calculation, inscribed sphere radius formula |
| 7 | Algebra (Algebra) | Challenging | Finding extreme values of derivatives, solving cubic equations by substitution method, Vedic theorem, inequality analysis |
| 8 | Integration (Integration) | Challenging | Integral of exponential functions, integral of trigonometric functions, summation of infinite geometric series, intersection of curves |
