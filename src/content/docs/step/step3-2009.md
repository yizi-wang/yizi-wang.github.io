...
|---|-------|------------|----------------|
| 1 | Coordinate Geometry and Circles | Standard | Similar triangles, Vedic theorem, the relationship between roots and coefficients, symmetrical letter substitution |
| 2 | Differential Equations and Power Series | Standard | Power series method, comparative coefficients, recursion formula, Taylor series identification |
| 3 | Function Analysis | Challenging | Lópida's rule, Taylor expansion, determination of even functions, symbolic analysis of derivatives, asymptotes |
| 4 | Laplace Transforms | Standard | Laplace transform definition, substitution integral, integral by parts, inverse transformation |
| 5 | Symmetric Polynomials and Recurrence Relations (Symmetric Polynomials and Recurrence Relations) | Standard | Symmetric polynomial identities, Vedic theorem, characteristic equations, recursion relations |
| 6 | Complex Numbers | Challenging | Euler's formula, half-angle formula, factoring formula, Ptolemy theorem |
| 7 | Calculus (Calculus) | Challenging | Mathematical induction, Leibniz's formula, product derivation, recurrence relations |
| 8 | Integration (Integration) | Challenging | Limits, integrals by parts, recurrence relations, power series expansion |

---

## Question 1

**Topic**: Coordinate Geometry and Circles &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
Expanding the numerator and grouping symmetrically:

 $$sv(mt - nu) + tu(ms - nv) = mstv - nsuv + mstu - ntuv$$ 
...
**Topic**: Differential Equations and Power Series &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Function Analysis &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Laplace Transforms &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Symmetric Polynomials and Recurrence Relations &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
Now set
 ...
 $$p = \frac{\beta-\alpha}{2}, \qquad q = \frac{\gamma-\beta}{2}, \qquad r = \frac{\delta-\gamma}{2}.$$ 

Then  $0 < p, q, r$ , and

 $$\frac{\delta-\alpha}{2}=p+q+r, \qquad \frac{\gamma-\alpha}{2}=p+q, \qquad \frac{\delta-\beta}{2}=q+r.$$ 
...
Substituting into the recurrence:
 ...
 $$= \frac{6x^2 - 2 - 8x^2 + 2 + 2x^2}{(1+x^2)^2} = \frac{0}{(1+x^2)^2} = 0 .$$ 
...
**Base cases:**  $P_0 = 1$  (degree 0),  $P_1 = -2x$  (degree 1),  $P_2 = 6x^2 - 2$  (degree 2).
...
8. (i) Letting  $x = e^{-t}$ ,
 $\lim_{x \to 0} [x^m (\ln x)^n] = \lim_{t \to \infty} [(e^{-t})^m (-t)^n] = (-1)^n \lim_{t \to \infty} [e^{-mt} t^n] = 0$ 
...
(iii)
 ...
 $$\int_{0}^{1} x^{x} dx = \int_{0}^{1} e^{x \ln x} dx = \int_{0}^{1} 1 + x \ln x + \frac{x^{2} (\ln x)^{2}}{2!} + \dots dx$$ 
...
= 1 - \left(\frac{1}{2}\right)^2 + \left(\frac{1}{3}\right)^3 - \left(\frac{1}{4}\right)^4 + \cdots .
$$ 
