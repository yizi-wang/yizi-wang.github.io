...
|---|-------|------------|----------------|
| 1 | Algebra & Equations (Algebra & Equations) | Standard | Cube expansion, parity analysis, divisibility argument |
| 2 | Series Expansion (Series Expansion) | Standard | Binomial theorem, fractional exponential expansion, numerical calculation |
| 3 | Series & Summation | Challenging | Partial fractions, elimination of split terms, recursive sequences |
| 4 | Integration (Integration) | Challenging | Recursive integrals, trigonometric identities, product difference elimination |
| 5 | Complex Numbers | Challenging | Complex number modules, triangle inequalities, mathematical induction, proof by contradiction |
| 6 | Coordinate Geometry & Calculus | Challenging | Derivatives of parametric equations, tangent normal equations, trigonometric identities |
| 7 | Inequalities & Calculus (Inequalities & Calculus) | Challenging | Derivative sign, proof of inequality, logarithmic derivation method, properties of trigonometric functions |
| 8 | Vector Geometry (Vector Geometry) | Challenging | Vector parametric equations, midpoint formula, common point proof, center of gravity coordinates |

---

## Question 1

**Topic**: Algebra & Equations &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Series Expansion &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Series & Summation &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
Find an expression for  $a_n/a_1$  and hence, or otherwise, evaluate  $\sum_{n=1}^{\infty} a_n$  when  $a_1 = \frac{2}{9}$ .
...
**Part 2: Using the recurrence for  $a_n$ **

For  $n \geq 2$ ,

 $$\frac{a_n}{a_1} = \prod_{k=2}^{n} \frac{(k - 1)(2k - 1)}{(k + 2)(2k - 3)}.$$ 

Separate the product into two telescoping parts:

 $$\prod_{k=2}^{n} \frac{k - 1}{k + 2} = \frac{1 \cdot 2 \cdot 3 \cdots (n - 1)}{4 \cdot 5 \cdot 6 \cdots (n + 2)} = \frac{6}{n(n + 1)(n + 2)},$$ 

and

 $$\prod_{k=2}^{n} \frac{2k - 1}{2k - 3} = \frac{3}{1}\cdot\frac{5}{3}\cdot\frac{7}{5}\cdots\frac{2n - 1}{2n - 3} = 2n - 1.$$ 

Hence

 $$\frac{a_n}{a_1} = \frac{6(2n - 1)}{n(n + 1)(n + 2)}.$$ 

This also gives  $\frac{a_1}{a_1}=1$  when  $n=1$ , so the formula is valid for all  $n \geq 1$ .

If  $a_1 = \frac{2}{9}$ , then

 $$a_n = \frac{2}{9}\cdot\frac{6(2n - 1)}{n(n + 1)(n + 2)} = \frac{4(2n - 1)}{3n(n + 1)(n + 2)}.$$ 

Using the first part of the question,

 $$\sum_{n=1}^{\infty} \frac{2n - 1}{n(n + 1)(n + 2)} = \lim_{N\to\infty} S_N = \frac{3}{4}.$$ 

Therefore

 $$\sum_{n=1}^{\infty} a_n = \frac{4}{3}\cdot\frac{3}{4} = \boxed{1}.$$ 
...
**Topic**: Coordinate Geometry & Calculus &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Inequalities & Calculus &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
From the third equation,  $\lambda = \mu$ . Substituting into the first:  $1 - \lambda = \lambda/2$ , giving  $\lambda = 2/3$ . We verify the second equation:  $\frac{1}{3} = 1 - \frac{2}{3} = \frac{1}{3}$ .  $\checkmark$ 
