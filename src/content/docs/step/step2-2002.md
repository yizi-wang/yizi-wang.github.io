...
|---|-------|------------|----------------|
| 1 | Integration | Standard | Trigonometric identity simplifies integrand, substitution method of integration, integral limit transformation |
| 2 | Polynomial Equations | Standard | Properties of reciprocal equations, variable substitution and reduction, solving quadratic equations |
| 3 | Number Theory | Standard | Mathematical induction, properties of Fermat numbers, proof by contradiction, divisibility argument |
| 4 | Inequalities and Integration | Challenging | Principle of integral positivity, discriminant of quadratic functions, trigonometric substitution, idea of integral by parts |
| 5 | Recurrence Relations and Dynamical Systems | Challenging | Analysis of recursion relations, solution of quadratic equations, fixed points and periodic points, proof of inequalities |
| 6 | Spatial Geometry and Trigonometry | Challenging | Trigonometric identities, direction cosines, geometric relations of inclined planes |
| 7 | Space Vectors 3D Vectors | Challenging | Vector dot product, direction cosine, coordinate geometry |
| 8 | Differential Equations | Challenging | Separation of variables method, piecewise function processing, continuity analysis |
...
**Topic**: Polynomial Equations &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Inequalities and Integration **Difficulty**: Challenging **Marks**: 20
...
**Topic**: Recurrence Relations and Dynamical Systems &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Spatial Geometry and Trigonometry &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Spatial Vectors 3D Vectors &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
