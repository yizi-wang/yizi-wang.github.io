...
|---|-------|------------|----------------|
| 1 | Algebra (Algebra) | Standard | Symmetric polynomials, elimination of simultaneous equations, root finding of quadratic equations |
| 2 | Sequences and Series (Sequences and Series) | Challenging | Sum of split terms, mathematical induction, binomial theorem expansion |
| 3 | Analytical Geometry (Coordinate Geometry) | Challenging | Parametric differentiation, finding intersection points of simultaneous equations, finding trajectories by elimination of parameters |
| 4 | Hyperbolic Functions (Hyperbolic Functions) | Challenging | Hyperbolic function identities, integrals by parts, inequality integrals |
| 5 | Recurrence Relations and Polynomials | Challenging | Mathematical induction, recursion relations, solution of characteristic equations, geometric sequence |
| 6 | Differential Equations | Challenging | Clairaut equation method, integral factor method, substitution differential |
| 7 | Complex Numbers | Challenging | Complex number rotation, geometric transformation, symmetry analysis |
| 8 | Series (Series) | Standard | Recurrence relations, elimination method of multiplication factors, decomposition of partial fractions, summation of geometric series |
...
**Topic**: Recurrence Relations and Polynomials &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Series &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
