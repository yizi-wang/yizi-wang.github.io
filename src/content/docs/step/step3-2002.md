...
|---|-------|------------|----------------|
| 1 | Calculus Calculus | Challenging | Integral by substitution, integral by parts, volume formula of a rotating body, generalized integral |
| 2 | Sequences and Series | Hard | Mathematical induction, arctangent addition formula, split term cancellation, series summation |
| 3 | Functions and Equations | Challenging | Radical function analysis, function image depiction, inequality analysis, algebraic equation solving |
| 4 | Number Theory | Hard | Inequality scaling, proof by contradiction, factorization, integer analysis |
| 5 | Algebra Algebra | Challenging | Combination method, undetermined coefficient method, polynomial identities, factorization |
| 6 | Differential Equations | Challenging | Separable variable method, case-by-case discussion, solution curve drawing |
| 7 | Trigonometry and Coordinate Geometry | Challenging | Trigonometric identities, coordinate methods, algebraic identity transformations, inequalities scaling |
| 8 | Complex Numbers | Hard | Complex number argument calculation, module operation, geometric interpretation, Ptolemy theorem |
...
**Topic**: Sequences and Series &nbsp;|&nbsp; **Difficulty**: Hard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Functions and Equations &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Trigonometry and Coordinate Geometry &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
