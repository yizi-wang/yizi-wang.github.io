...
|---|-------|------------|----------------|
| 1 | Curve Analysis and Sketching | Standard | Curve drawing, asymptote method, tangent equation, image analysis method |
| 2 | Integration | Challenging | Variable substitution, trigonometric identities, utilization of symmetry, parameter discussion |
| 3 | Trigonometric Series and Summation | Challenging | Power series expansion, trigonometric identities, comparison of coefficients on both sides of the equation, recursion relations |
| 4 | Functional Equations | Standard | Solving functional equations, Maclaurin series, variable substitution, function composition |
| 5 | Complex Numbers and Geometry (Complex Numbers and Geometry) | Challenging | The geometric meaning of complex numbers, the relationship between roots and coefficients, equilateral triangle conditions, linear transformation |
| 6 | Polar Coordinates and Calculus | Challenging | Polar coordinate differential, trigonometric identity transformation, solution of differential equations, parabolic polar coordinate equation |
| 7 | Differential Equations | Challenging | Conversion of hyperbolic functions and exponential functions, factorization of quadratic equations, separation of variables and integration, asymptote analysis |
| 8 | Abstract Algebra and Differentiation | Challenging | Operator substitution, product rule (Leibniz's rule), mathematical induction, polynomial expansion |

---

## Question 1

**Topic**: Curve Analysis and Sketching &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Trigonometric Series and Summation &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Complex Numbers and Geometry &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Polar Coordinates and Calculus &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Abstract Algebra and Differentiation &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
