...
|---|-------|------------|----------------|
| 1 | Differential Equations | Standard | Variable substitution, integration factors, reduction method |
| 2 | Algebra Algebra | Standard | Rational root theorem, proof by contradiction, divisibility analysis |
| 3 | Algebra Algebra | Challenging | Factorization of cubic polynomials, complex unit roots, algebraic identities |
| 4 | Analysis Analysis | Challenging | Young's inequality, integral properties, inverse trigonometric functions |
| 5 | Geometry and Mechanics | Hard | Parametric equations, swept area formula, trigonometric integral |
| 6 | Integral Calculus | Challenging | Variable substitution, hyperbolic function identities, artanh and logarithmic relations |
| 7 | Number Theory & Algebra | Challenging | Mathematical induction, binomial expansion, Pell equation structure |
| 8 | Complex Numbers | Challenging | Möbius transformation, separation of real and imaginary parts, half-angle substitution tan(θ/2), trajectory analysis |

---

## Question 1

**Topic**: Differential Equations Differential Equations &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Algebra Algebra &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Algebra Algebra &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Analysis Analysis &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Geometry and Mechanics Geometry and Mechanics &nbsp;|&nbsp; **Difficulty**: Hard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Points Integral Calculus &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Number Theory & Algebra Number Theory & Algebra &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
