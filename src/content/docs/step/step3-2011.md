...
$x_A \dot{y}_A = (x - a\cos t)(\dot{y} - a\cos t)$
$= x\dot{y} - ax\cos t - a\dot{y}\cos t + a^2\cos^2 t$

$y_A \dot{x}_A = (y - a\sin t)(\dot{x} + a\sin t)$
$= y\dot{x} + ay\sin t - a\dot{x}\sin t - a^2\sin^2 t$
