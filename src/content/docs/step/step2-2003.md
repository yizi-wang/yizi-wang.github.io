...
|---|-------|------------|----------------|
| 1 | Systems of Linear Equations | Standard | Parameter discussion, solution of linear equations, constrained optimization |
| 2 | Trigonometric and Inverse Trigonometric Functions | Standard | Auxiliary angle formula, inverse trigonometric function identity |
| 3 | Irrational numbers and proof (Irrationality and Proof) | Challenging | Proof by contradiction, mathematical induction, limit construction |
| 4 | Analytic Geometry | Standard | Arc area formula, inverse cosine function, coordinate transformation |
| 5 | Vectors | Standard | Vector parametric equations, midpoint formulas, coplanarity conditions |
| 6 | Function Iteration and Integration | Challenging | Function iteration, absolute value function image, trigonometric function integral |
| 7 | Integration and Series (Integration and Series) | Challenging | Integrals by parts, abnormal integrals, series scaling |
| 8 | Differential Equations | Standard | Separating variables, stationary point analysis, asymptotic behavior |

---

## Question 1

**Topic**: Systems of Linear Equations &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Trigonometric and Inverse Trigonometric Functions &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Irrationality and Proof &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Analytic Geometry &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Function Iteration and Integration &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Integration and Series &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Differential Equations &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
