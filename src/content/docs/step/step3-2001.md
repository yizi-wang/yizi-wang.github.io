...
|---|-------|------------|----------------|
| 1 | Calculus Calculus | Challenging | Implicit function derivation, mathematical induction, recurrence relations, Maclaurin series expansion |
| 2 | Calculus Calculus | Challenging | Identity of inverse hyperbolic function, area calculation by integral, region boundary analysis |
| 3 | Algebra and Equations | Standard | Discriminant analysis, Vedic theorem, inequality constraints, area mapping |
| 4 | Calculus Calculus | Challenging | Inverse trigonometric function identities, piecewise function analysis, function image depiction |
| 5 | Calculus Calculus | Hard | Cubic equation analysis, parametric equation normal, trajectory equation derivation, classification discussion |
| 6 | Solid Geometry / 3D Geometry | Challenging | Vector method, plane equations, special points of triangles, geometric proofs |
| 7 | Differential Equations | Challenging | Orthogonal trajectory method, separable variable differential equations, curve families and envelopes |
| 8 | Complex Numbers / Complex Numbers | Hard | Complex module and argument, locus equation, fractional linear transformation, complex plane geometry |

---

## Question 1

**Topic**: Calculus Calculus &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Algebra and Equations &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Calculus Calculus &nbsp;|&nbsp; **Difficulty**: Hard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: 3D Geometry &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
