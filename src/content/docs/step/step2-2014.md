...
|---|-------|------------|----------------|
| 1 | Geometry & Trigonometry | Standard | Trigonometric identity cos²θ+sin²θ=1, discriminant of quadratic equations, coordinate geometry distance analysis, geometric reasoning on extension lines |
| 2 | Calculus (Calculus) | Challenging | Trigonometric function integral calculation, counterexample construction method, quadratic function substitution into inequality, trigonometric function substitution into inequality, comparison of approximate values of π |
| 3 | Calculus (Calculus) | Challenging | Point-to-line distance formula, implicit function differential, solution of differential equations, analysis of the special case of y''=0, derivation of the equation of a circle |
| 4 | Calculus (Calculus) | Standard | u=1/x substitution, integral properties on symmetric intervals, arctan identity, parameter selection skills, infinite integral calculation |
| 5 | Differential Equations | Standard | y=xu substitution of homogeneous differential equations, separation of variables method, coordinate translation elimination of constant terms, substitution of initial value conditions |
| 6 | Trigonometric functions and series (Trigonometric Series) | Challenging | Sum of trigonometric identities, derivatives to find stationary points, mathematical induction, proof of inequalities |
| 7 | Absolute Value Functions & Equations | Standard | Piecewise function analysis, image drawing, absolute value equation solution, classification discussion |
| 8 | Binomial Expansion & Combinatorics | Hard | Binomial coefficient formula, ratio method to judge monotonicity, inequality scaling, classification discussion |

---

## Question 1

**Topic**: Geometry & Trigonometry &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Trigonometric Series &nbsp;|&nbsp; **Difficulty**: Challenging &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Absolute Value Functions & Equations &nbsp;|&nbsp; **Difficulty**: Standard &nbsp;|&nbsp; **Marks**: 20
...
**Topic**: Binomial Expansion & Combinatorics &nbsp;|&nbsp; **Difficulty**: Hard &nbsp;|&nbsp; **Marks**: 20
