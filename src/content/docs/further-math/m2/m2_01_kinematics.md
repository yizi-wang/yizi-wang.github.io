...
:::note[picture]
Schematic diagram of projectile motion coordinates (corresponding to the original TikZ diagram).
:::

![Projectile motion trajectory](/images/tikz/m2-projectile-motion.svg)
